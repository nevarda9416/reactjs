        ...
        if (response.length) {
          ...
          dbo.collection(collection_system_name).findOne({type: req.body.system_type}, function (error, response) {
            ...
            if (response) {
              ...
              const listingQueryAction = {subject: 'Create product'};
              const updateActions = {
                $set: {
        ...
        if (response.length) {
          ...
          dbo.collection(collection_system_name).findOne({type: req.body.system_type}, function (error, response) {
            ...
            if (response) {
              ...
              const listingQueryAction = {subject: 'Update product'};
              const updateActions = {
                $set: {
        ...
        if (response.length) {
          ...
          dbo.collection(collection_system_name).findOne({type: req.body.system_type}, function (error, response) {
            ...
            if (response) {
              ...
              const listingQueryAction = {subject: 'Delete product'};
              const updateActions = {
                $set: {
        ...
        if (response.length) {
          ...
          dbo.collection(collection_system_name).findOne({type: req.body.system_type}, function (error, response) {
            ...
            if (response) {
              ...
              const listingQueryAction = {subject: 'Crawl product detail'};
              const updateActions = {
                $set: {
                  subject: 'Crawl product detail',
                  content: 'Crawl product detail',
                  url: '/products/crawl/detail',
                  method: 'POST',
                  function: null,
                  ip: null,
                  agent: null,
        ...
        if (response.length) {
          ...
          dbo.collection(collection_system_name).findOne({type: req.body.system_type}, function (error, response) {
            ...
            if (response) {
              ...
              const listingQueryAction = {subject: 'Crawl product list'};
              const updateActions = {
                $set: {
                  subject: 'Crawl product list',
                  content: 'Crawl product list: ' + req.body.name,
                  url: '/products/crawl/list',
                  method: 'POST',
                  function: null,
                  ip: null,
                  agent: null,
